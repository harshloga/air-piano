...
while True:
    ...
    # 1_h=cv.getTackbarPos("L-H", "Trackbar")
    # 1_s=cv.getTackbarPos("L-S", "Trackbar")
    # 1_v=cv.getTackbarPos("L-V", "Trackbar")
    # u_h=cv.getTackbarPos("U-H", "Trackbar")
    # u_s=cv.getTackbarPos("U-S", "Trackbar")
    # u_v=cv.getTackbarPos("U-V", "Trackbar")

    #lower_black=np.array([1_h,1_s,1_v]) # get proper values from experiment with trackbar.
    #upper_black=np.array([u_h,u_s,u_v])
        
    lower_black=np.array([0,0,0]) # get proper values from experiment with trackbar.
